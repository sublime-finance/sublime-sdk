...
interface CLAdminInterface extends ethers.utils.Interface {
  functions: {
    ...
    'deployCLContracts(address,address,address,address,address)': FunctionFragment;
    ...
    'updateBorrowLimit(address,uint256,uint128)': FunctionFragment;
    'updateBorrowLimitLimits(uint256,uint256,address)': FunctionFragment;
    'updateBorrowRateLimits(uint256,uint256,address)': FunctionFragment;
    'updateIdealCollateralRatioLimits(uint256,uint256,address)': FunctionFragment;
    'updateLiquidatorRewardFraction(uint256,address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'deployCLContracts', values: [string, string, string, string, string]): string;
  ...
  encodeFunctionData(functionFragment: 'updateBorrowLimit', values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'updateBorrowLimitLimits', values: [BigNumberish, BigNumberish, string]): string;
  encodeFunctionData(functionFragment: 'updateBorrowRateLimits', values: [BigNumberish, BigNumberish, string]): string;
  encodeFunctionData(functionFragment: 'updateIdealCollateralRatioLimits', values: [BigNumberish, BigNumberish, string]): string;
  encodeFunctionData(functionFragment: 'updateLiquidatorRewardFraction', values: [BigNumberish, string]): string;
  ...
  decodeFunctionResult(functionFragment: 'deployCLContracts', data: BytesLike): Result;
...
export class CLAdmin extends Contract {
  ...
  functions: {
    ...
    'deployCLContracts(address,address,address,address,address)'(
      _mockUSDC: string,
      _priceOracle: string,
      _savingsAccount: string,
      _strategyRegistry: string,
    ...
    'updateBorrowLimit(address,uint256,uint128)'(
      creditLineAddress: string,
      id: BigNumberish,
      newBorrowLimit: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    updateBorrowLimitLimits(
      _min: BigNumberish,
      _max: BigNumberish,
      _creditLinAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    'updateBorrowLimitLimits(uint256,uint256,address)'(
      _min: BigNumberish,
      _max: BigNumberish,
      _creditLinAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    'updateBorrowRateLimits(uint256,uint256,address)'(
      _min: BigNumberish,
      _max: BigNumberish,
      _creditLinAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    'updateIdealCollateralRatioLimits(uint256,uint256,address)'(
      _min: BigNumberish,
      _max: BigNumberish,
      _creditLinAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    'updateLiquidatorRewardFraction(uint256,address)'(
      _rewardFraction: BigNumberish,
      _creditLinAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    'updateProtocolFeeFraction(uint256,address)'(
  ...
  callStatic: {
    ...
    updateBorrowLimit(creditLineAddress: string, id: BigNumberish, newBorrowLimit: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    updateBorrowLimitLimits(_min: BigNumberish, _max: BigNumberish, _creditLinAddress: string, overrides?: CallOverrides): Promise<void>;
    ...
    updateBorrowRateLimits(_min: BigNumberish, _max: BigNumberish, _creditLinAddress: string, overrides?: CallOverrides): Promise<void>;
    ...
    updateLiquidatorRewardFraction(_rewardFraction: BigNumberish, _creditLinAddress: string, overrides?: CallOverrides): Promise<void>;
    ...
    updateProtocolFeeCollector(_protocolFeeCollector: string, _creditLinAddress: string, overrides?: CallOverrides): Promise<void>;
