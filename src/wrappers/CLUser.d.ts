...
interface CLUserInterface extends ethers.utils.Interface {
  functions: {
    ...
    'createRequest(address,tuple)': FunctionFragment;
    ...
    'withdrawAllCollateral(address,uint256,bool)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'withdrawAllCollateral', values: [string, BigNumberish, boolean]): string;
...
export class CLUser extends Contract {
  ...
  functions: {
    ...
    'createRequest(address,(address,uint128,uint128,bool,uint256,address,address,address,address,bool))'(
      creditLineAddress: string,
      requestData: {
        requestTo: string;
        borrowLimit: BigNumberish;
    ...
    'withdrawAllCollateral(address,uint256,bool)'(
      creditLineAddress: string,
      id: BigNumberish,
      toSavingsAccount: boolean,
      overrides?: Overrides & { from?: string | Promise<string> }
  ...
  callStatic: {
    ...
    withdrawAllCollateral(creditLineAddress: string, id: BigNumberish, toSavingsAccount: boolean, overrides?: CallOverrides): Promise<void>;
