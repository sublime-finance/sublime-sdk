...
[src/subgraph/CreditLineInterestCalculator.ts:22](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L22)
...
[src/subgraph/CreditLineInterestCalculator.ts:190](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L190)
...
▸ `Private` **transformToInterestDue**(`interestDuePerTokenPerStrategy`, `prices`): `Promise`<[`InterestDue`](../interfaces/types_overview_InterestDetails.InterestDue.md)\>
...
[src/subgraph/CreditLineInterestCalculator.ts:145](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L145)

___

### transformToInterestDueDetail

▸ `Private` **transformToInterestDueDetail**(`data`): `Promise`<[`InterestDueDetails`](../interfaces/types_overview_InterestDetails.InterestDueDetails.md)\>
...
[src/subgraph/CreditLineInterestCalculator.ts:61](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L61)

___

### transformToInterestDuePerStrategy

▸ `Private` **transformToInterestDuePerStrategy**(`interestDuePerTokenPerStrategy`, `prices`): `Promise`<[`InterestDuePerStrategy`](../interfaces/types_overview_InterestDetails.InterestDuePerStrategy.md)[]\>
...
[src/subgraph/CreditLineInterestCalculator.ts:89](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L89)

___

### transformToInterestDuePerToken

▸ `Private` **transformToInterestDuePerToken**(`interestDuePerTokenPerStrategy`): `Promise`<[`InterestDuePerToken`](../interfaces/types_overview_InterestDetails.InterestDuePerToken.md)[]\>
...
[src/subgraph/CreditLineInterestCalculator.ts:121](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L121)

___

### transformToInterestDuePerTokenPerStrategy

▸ `Private` **transformToInterestDuePerTokenPerStrategy**(`data`, `prices`): `Promise`<[`InterestDuePerTokenPerStrategy`](../interfaces/types_overview_InterestDetails.InterestDuePerTokenPerStrategy.md)[]\>
...
[src/subgraph/CreditLineInterestCalculator.ts:162](https://github.com/sublime-finance/sublime-sdk/blob/f8c66d9/src/subgraph/CreditLineInterestCalculator.ts#L162)
